...
Economic Area) to create a Seqtrix account. By signing up you confirm
...
You agree NOT to use Seqtrix to:
...
7. Resell, sublicense, or white-label Seqtrix without a written
   agreement with us.
...
We own the Seqtrix software, branding, website, and all related
...
- Files you process with Seqtrix.
